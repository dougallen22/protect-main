...
function fetch_all_users()
  {
   var dataTable = $('#all_users_info').DataTable({
    "processing" : true,
    "serverSide" : true,
    "order" : [],
    "lengthMenu": [[50, 100, 200, -1], [50, 100, 200, "All"]],
...
function fetch_all_plans()
  {
   var dataTable = $('#all_users_plans').DataTable({
    "processing" : true,
    "serverSide" : true,
    "order" : [],
    "lengthMenu": [[50, 100, 200, -1], [50, 100, 200, "All"]],
...
function fetch_queries()
  {
   var dataTable = $('#queries').DataTable({
    "processing" : true,
    "serverSide" : true,
    "order" : [],
     "aoColumnDefs": [
