...
<body>
    ...
    <div class="container">
        <div class="wrapper">
                ...
                <p>Thank you for choosing to be part of our community at Protect Mutual ("Company," "we," "us," or "our"). 
                ...
                contact us at info@protectmutual.com.

                This privacy notice describes how we might use your information if you:
                Visit our website at http://www.protectmutual.com
                Use our Facebook application — Protect Mutual
                ...
                that we collect.</p><br>
               
                <h3>TABLE OF CONTENTS</h3><br>
                <div class="wrap1">
                <div class="accordion-tab">
                    <input id="toggle1" type="checkbox" class="accordion-toggle" name="toggle" />
                    <label for="toggle1">What information do we collect?</label>
                    <div class="accordion-content">
                        <p> In Short:  We collect personal information that you provide to us.
                            ...
                            In Short:  We collect information regarding your push notifications, Facebook permissions, when you use 
                            our App.
                            If you use our App, we also collect the following information:
                            Push Notifications. We may request to send you push notifications regarding your account or certain features
                            of the App. If you wish to opt-out from receiving these types of communications, you may turn them off 
                            in your device's settings.
                            Facebook Permissions. We by default access your Facebook basic account information, including your name, 
                            email, gender, birthday, current city, and profile picture URL, as well as other information that you 
                            choose to make public. We may also request access to other permissions related to your account, such as 
                            friends, checkins, and likes, and you may choose to grant or deny us access to each individual permission. 
                            ...
                            mailing addresses, job titles, email addresses, phone numbers, intent data (or user behavior data), 
                            Internet Protocol (IP) addresses, social media profiles, social media URLs and custom profiles, for 
                            purposes of targeted advertising and event promotion.</p>         
                    </div>
                </div>                      

                <div class="accordion-tab">
                    <input id="toggle2" type="checkbox" class="accordion-toggle" name="toggle" />
                    <label for="toggle2">How do we use your information?</label>
                        <div class="accordion-content">
                ...
                <div class="accordion-tab">
                    ...
                    <label for="toggle3">Will we share your information?</label>
                        <div class="accordion-content">
                 ...
                 <div class="accordion-tab">
                        ...
                        <label for="toggle4">Do we use cookies or other tracking technologies?</label>
                            <div class="accordion-content">
                ...
                <div class="accordion-tab">
                        ...
                        <label for="toggle5">How long do we keep your information?</label>
                            <div class="accordion-content">
                ...
                <div class="accordion-tab">
                    ...
                    <label for="toggle6">How do we keep your information safe?</label>
                        <div class="accordion-content">
                ...
                <div class="accordion-tab">
                    ...
                    <label for="toggle8">What are your privacy rights?</label>
                        <div class="accordion-content">
                            <p>In Short:  You may review, change, or terminate your account at any time.
                               ...
                               If you are a resident in Switzerland, the contact details for the data protection authorities are available here: https://www.edoeb.admin.ch/edoeb/en/home.html.</p><br>
                                ...
                                Access your account settings and update your preferences.</p>
                               </p>         
                        </div>
                </div>
                ...
                <div class="accordion-tab">
                    ...
                    <label for="toggle9">Controls for do not track features?</label>
                        <div class="accordion-content">
                ...
                <div class="accordion-tab">
                    ...
                    <label for="toggle10">Do California residents have specific privacy rights ?</label>
                        <div class="accordion-content">
                                <p>In Short:  Yes, if you are a resident of California, you are granted specific rights regarding access to your personal information.
                                    ...
                                    You may contact us by email at info@koverking.com, or by referring to the contact details at the bottom of this document.
                                    ...
                                    Kover King has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding 12 months. Kover King will not sell personal information in the future belonging to website visitors, users and other consumers.
                                    ...
                                    To exercise these rights, you can contact us by email at info@koverking.com, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.  
                ...
                <div class="accordion-tab">
                    <input id="toggle11" type="checkbox" class="accordion-toggle" name="toggle" />
                    <label for="toggle11">Do we update this notice?</label>
                        <div class="accordion-content">
                ...
                <div class="accordion-tab">
                    <input id="toggle12" type="checkbox" class="accordion-toggle" name="toggle" />
                    <label for="toggle12">How can you contact us about this?</label>
                        <div class="accordion-content">
                                <p>If you have questions or comments about this notice, you may email us at info@protectmutual.com or by post to:</p>
                                   <p> Protect Mutual<br>
                                    7612 Wentworth Dr<br>
                ...
                <div class="accordion-tab">
                    <input id="toggle13" type="checkbox" class="accordion-toggle" name="toggle" />
                    <label for="toggle13">How can you review, update or delete the data we collect from you?</label>
                        <div class="accordion-content">
                                <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please visit: protectmutual.com.
                                </p>         
                         </div>
                 </div>            
