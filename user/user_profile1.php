            ...
            <div class="tab-content">
              <div class="active tab-pane" id="login_info">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="fname"  value="<?php echo $r['first_name'];  ?>" placeholder="First Name" <?php if($username==$r['user_name'] && $r['user_type']!='admin'){ echo "readonly"; } ?> >
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="lname"  value="<?php echo $r['last_name'];  ?>" placeholder="Last Name" <?php if($username==$r['user_name'] && $r['user_type']!='admin'){ echo "readonly"; } ?> >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="email"  value="<?php echo $r['email'];  ?>" placeholder="Email" <?php if($username==$r['user_name'] && $r['user_type']!='admin'){ echo "readonly"; } ?> >
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="uname"  value="<?php echo $r['user_name'];  ?>" placeholder="Userame" <?php if($username==$r['user_name'] && $r['user_type']!='admin'){ echo "readonly"; } ?> >
                    </div>
                  </div>
...
<input type="hidden"  name="id" value="<?php echo $r['id'] ?>">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="password" id="inputEmail" placeholder="Password" value="<?php echo base64_decode($r['password']);  ?>" <?php if($username==$r['user_name'] && $r['user_type']!='admin'){ echo "readonly"; } ?> 
                    </div>
                  </div>
                  </div>
