...
?>
 <input type="hidden" name="r_iddd" value="<?php echo $row['id']; ?>" >
                                 ...
                                 <th>Gender :</th><td colspan="2"><select name="gender" class="form-control"><option <?php if($row['gender']=='MALE'){ echo "selected"; } ?> value="MALE">MALE</option><option <?php if($row['gender']=='FEMALE'){ echo "selected"; } ?> value="FEMALE">FEMALE</option></select></td>
                                 <th>Company Name :</th><td colspan="2"><input type="text" name="company_name" placeholder="Comapnay Name" class="form-control" required="" value="<?php echo $row['company_name']; ?>" /></td>
                                 </tr>
               <tr>
